(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function useMap3DInstances() {
        const [map3dInstances, setMap3DInstances] = React.useState({});
    ...
    function useGoogleMapsApiLoader(props) {
        ...
        const currentSerializedParams = React.useMemo(() => {
            const params = {
                apiKey,
                version,
        ...
        const importLibraryCallback = React.useCallback((name) => __awaiter(this, void 0, void 0, function* () {
    ...
    function useInternalUsageAttributionIds(props) {
        return React.useMemo(() => props.disableUsageAttribution
            ? null
    ...
    var _a;
    const { useLayoutEffect, useRef } = React__namespace;
    ...
    const useBeforeEffect = (_a = React__namespace.useInsertionEffect) !== null && _a !== void 0 ? _a : useLayoutEffect;
    ...
    function useTrackedCameraStateRef3D(map3d) {
        const forceUpdate = useForceUpdate();
        const ref = React.useRef(Object.assign({}, DEFAULT_CAMERA_STATE));
        React.useEffect(() => {
            if (!map3d)
                return;
            const listeners = [];
    ...
    function useMap3DInstance(props) {
        ...
        const [customElementReady, setCustomElementReady] = React.useState(false);
     ...
     */
    const GoogleMaps3DContext = React.createContext(null);
    /**
     ...
     * ```
     */
    const Map3D = React.forwardRef((props, ref) => {
        const { children, id, className, style } = props;
        ...
        const combinedStyle = React.useMemo(() => (Object.assign(Object.assign({}, DEFAULT_CONTAINER_STYLE), style)), [style]);
        const contextValue = React.useMemo(() => ({ map3d }), [map3d]);
        if (!isReady) {
            return (React.createElement("div", Object.assign({ ref: containerRef, "data-testid": "map-3d", style: className ? undefined : combinedStyle, className: className }, (id ? { id } : {}))));
        }
        return (React.createElement("div", Object.assign({ ref: containerRef, "data-testid": "map-3d", style: className ? undefined : combinedStyle, className: className }, (id ? { id } : {})),
            React.createElement("gmp-map-3d", { ref: map3dRef, style: { width: '100%', height: '100%' } }, map3d && (React.createElement(GoogleMaps3DContext.Provider, { value: contextValue }, children)))));
    });
    Map3D.displayName = 'Map3D';

    const Marker3DContext = React.createContext(null);
    /**
     * Hook to access the Marker3D context.
     */
    function useMarker3D() {
        return React.useContext(Marker3DContext);
    }
    /**
     ...
     * ```
     */
    const Marker3D = React.forwardRef(function Marker3D(props, ref) {
        ...
        const [contentHandledExternally, setContentHandledExternally] = React.useState(false);
        ...
        const contextValue = React.useMemo(() => ({ marker, setContentHandledExternally }), [marker]);
        usePropBinding(marker, 'position', position);
        ...
        usePropBinding(marker, 'zIndex', zIndex);
        usePropBinding(marker, 'title', title !== null && title !== void 0 ? title : '');
        return (React.createElement(Marker3DContext.Provider, { value: contextValue },
            isInteractive ? (React.createElement("gmp-marker-3d-interactive", { ref: markerRef })) : (React.createElement("gmp-marker-3d", { ref: markerRef })),
    ...
    const Popover = React.forwardRef(function Popover(props, ref) {
        ...
        React.useImperativeHandle(ref, () => popover, [popover]);
        ...
        return (React.createElement("gmp-popover", { ref: setPopover, className: className },
            headerContent && React.createElement("div", { slot: "header" }, headerContent),
            children));
    });
    ...
    function usePopoverCloseObserver(popover, open, onClose) {
        const previousOpenState = React.useRef(undefined);
        const openPropRef = React.useRef(open);
    ...
    const PinLegacy = props => {
        const advancedMarkerContext = React.useContext(AdvancedMarkerContext);
        const marker3dContext = React.useContext(Marker3DContext);
    ...
    const PinModern = props => {
        ...
        return reactDom.createPortal(children, glyphContainer);
    };
    ...
    const Pin = props => {
        ...
        if (isModern) {
            ...
            return (React.createElement(PinModern, Object.assign({}, restProps, { glyphText: finalGlyphText, glyphSrc: finalGlyphSrc })));
        }
        else {
    ...
    const Rectangle = React.forwardRef((props, ref) => {
        ...
        React.useImperativeHandle(ref, () => rectangle, [
            rectangle
        ]);
        return React.createElement(React.Fragment, null);
    });
    ...
    function useMap3D(id = null) {
        const apiContext = React.useContext(APIProviderContext);
        const map3dContext = React.useContext(GoogleMaps3DContext);
        if (apiContext === null) {
    ...
    exports.Marker3DContext = Marker3DContext;
    exports.Pin = Pin;
    ...
    exports.__resetModuleState = __resetModuleState;
    exports.boundsEquals = boundsEquals;
    ...
    exports.pathsEquals = pathsEquals;
    exports.toLatLngBoundsLiteral = toLatLngBoundsLiteral;
    ...
    exports.useMap3D = useMap3D;
    exports.useMapsLibrary = useMapsLibrary;
    exports.useMarker3D = useMarker3D;
